                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        ...
                        <a href="" class="flex ml-2 md:mr-24">
                            ...
                            <span class="hidden md:block self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-gray-700 dark:text-white">Assets Management System</span>
                        </a>
                    </div>
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center ml-3">
                            <div>
                                ...
                                <img class="w-8 h-8 rounded-full" src="src/images/avatar.svg" alt="user photo">
                                </button>
                            </div>
                            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                                ...
                                <ul class="" role="none">
                                    <li>
                                        <a href="index.php" class="<?php active('index.php');?> block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">System</a>
                                    </li>
                                    <li>
                                        <a href="profile.php" class="<?php active('profile.php');?> block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Profile</a>
                                    </li>
                                    <li>
